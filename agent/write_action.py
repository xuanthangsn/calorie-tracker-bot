"""Concrete write action: overwrite whole file in the LLM workspace."""
...
class WriteParamsModel(BaseModel):
    """Validation schema for `write` action params (implemented_actions.md)."""
...
class WriteAction(BaseAction):
    """Overwrite the entire target file with new content (create if missing)."""
